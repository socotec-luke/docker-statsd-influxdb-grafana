...
RUN git clone https://github.com/tribe29/grafana-checkmk-datasource.git check_mk-plugin/ && \
	mkdir /var/lib/grafana/plugins/check_mk -p && \
	cp -r check_mk-plugin/dist /var/lib/grafana/plugins/check_mk
